...
object ImportMultiLineRecords extends Serializable {
   ...
   * JSON记录可以跨越多行,返回每行包含JSON字符串的一个Frame的Frame
   *
   ...
   *  importJson创建一个框架,其中每一行包含一个JSON字符串,如...
   *  [#]  records
   *  =====================================================================
   *  [0]  { "obj": {
   *       "color": "blue",
   ...
   * XML记录可以跨越多行,返回每行包含一个XML字符串的一个Frame的Frame
