...
class DotProductTest extends TestingSparkContextWordSpec with Matchers {
  ...
  "dotProduct" should {
    ...
    //使用Double.NaN的默认值计算double的向量的点积
  ...
  "computeDotProduct" should {
    ...
    //如果left向量是空的，则抛出IllegalArgumentException
    ...
    //如果右向量为空，则抛出IllegalArgumentException
    ...
    //如果向量的大小不一致,则抛出IllegalArgumentException
